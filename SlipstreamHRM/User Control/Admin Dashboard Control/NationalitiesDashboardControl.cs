...
namespace SlipstreamHRM.User_Control.Admin_Dashboard_Control
{
    ...
    {
        private static NationalitiesDashboardControl _instance;

        public static NationalitiesDashboardControl Instance
        {
            get
            {
                if (_instance == null)
        ...
        public void dataShow()
        {
            try
            {
                ...
                regionDataGridView.DataSource = RegionInfoTable1;
       ...
       private void AddTile_Click1(object sender, EventArgs e)
        ...
        private void DeleteTile_Click1(object sender, EventArgs e)
        {
